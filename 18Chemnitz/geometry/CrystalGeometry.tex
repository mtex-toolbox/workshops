...
\begin{column}{3.7cm}
  \vspace{-0.5cm}
  \only<4>{\includegraphics[width=3.7cm]{pic/scatterEuler.pdf}}
  \only<5>{\includegraphics[width=3.7cm]{pic/rotationScatter.png}}
\end{column}
...
plot(oR,'color','r')
    ...
    \begin{column}{0.45\textwidth}
      ...
      \only<2>{\includegraphics[width=\textwidth]{pic/oRmmm}}
      \only<3>{\includegraphics[width=\textwidth]{pic/oR321}}
      \only<4->{\includegraphics[width=\textwidth]{pic/oR432}}
    \end{column}
  \end{columns}
...
\begin{column}{5cm}
  \only<1>{\includegraphics[width=\textwidth]{pic/o1.pdf}}
  \only<2>{\includegraphics[width=\textwidth]{pic/o2.pdf}}
  \only<3>{\includegraphics[width=\textwidth]{pic/fibre1.pdf}}
  \only<4>{\includegraphics[width=\textwidth]{pic/fibreFull.pdf}}
  \only<5>{\includegraphics[width=\textwidth]{pic/fibreSym.pdf}}
  \only<6>{\includegraphics[width=\textwidth]{pic/fibreBeta.pdf}}
  \only<7->{\includegraphics[width=\textwidth]{pic/fibre2.pdf}}
\end{column}
...
\begin{column}{3.5cm}
  \only<1>{\centering{\includegraphics[width=0.6\textwidth]{pic/quartz.png}}}
  \only<2>{\includegraphics[width=\textwidth]{pic/twins.png}}
  \only<3>{\includegraphics[width=\textwidth]{pic/pfcS.png}}
  \only<4>{\includegraphics[width=\textwidth]{pic/pfcSred.png}}
\end{column}
